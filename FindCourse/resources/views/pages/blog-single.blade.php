                    ...
                    <div class="ro">
                        <div
                            ...
                            <ul class="tc uf cg 2xl:ud-gap-15 fb">
                                <li><span class="rc kk wm">Author:
                                    </span> Devid Cleriya
                                </li>
                                <li><span class="rc kk wm">Published
                                        On: </span> April
                                    16, 2025</li>
                                <li><span class="rc kk wm">Category:
                                    </span> Events</li>
                            </ul>
                    ...
                    <div class="jn/2 so">
                        ...
                        <div class="animate_top">
                            ...
                            <div>
                                ...
                                <div class="tc fg 2xl:ud-gap-6 qb">
                                    <img src="{{asset('images/blog-small-02.png')}}" alt="Blog" />
                                    <h5 class="wj kk wm xl bn ml il">
                                        <a href="#!">9
                                            simple ways to
                                            improve your
                                ...
                                <div class="tc fg 2xl:ud-gap-6">
                                    <img src="{{asset('images/blog-small-03.png')}}" alt="Blog" />
                                    <h5 class="wj kk wm xl bn ml il">
                                        <a href="#!">Tips
                                            to quickly
                                            improve your
